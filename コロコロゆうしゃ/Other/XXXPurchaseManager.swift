...
class XXXPurchaseManager : NSObject,SKPaymentTransactionObserver {
    ...
    func paymentQueueRestoreCompletedTransactionsFinished(queue: SKPaymentQueue) {
        ...
        //リストア完了時に呼ばれる
        self.delegate?.purchaseManagerDidFinishRestore?(self, queue: queue)
...
@objc protocol XXXPurchaseManagerDelegate {
    ...
    //リストア完了
    optional func purchaseManagerDidFinishRestore(purchaseManager: XXXPurchaseManager!, queue: SKPaymentQueue)
    //課金失敗
